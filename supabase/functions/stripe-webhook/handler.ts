...
export const createHandler = (stripe: Stripe, supabaseAdmin: SupabaseClient, webhookSecret?: string) => async (req: Request): Promise<Response> => {
    // 1. Handle CORS Preflight
    if (req.method === 'OPTIONS') {
        return new Response('ok', { headers: corsHeaders });
    }

    // 2. Validate Stripe Webhook Signature
