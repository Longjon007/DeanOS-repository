...
- **Curate domain data:** Feed the agent high-quality examples (task transcripts, successful outputs, edge cases) via few-shot prompts or small fine-tuning runs.
...
- **Reinforce good behavior:** Use RLHF (Reinforcement Learning from Human Feedback) or DPO (Direct Preference Optimization) style preference data to reward reliable, safe outputs and reduce hallucinations.
